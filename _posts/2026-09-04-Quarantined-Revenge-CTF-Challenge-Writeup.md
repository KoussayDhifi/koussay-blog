---
title: Quarantined REVENGE web CTF challenge writeup
description: A writeup for the CTF web challenge titled Quarantined REVENGE from the InfernoCTFv2.
...
This is a step-by-step writeup for the Quarantined REVENGE CTF challenge from InfernoCTFv2, established by [Securinets ISTIC](https://www.facebook.com/p/SecuriNets-ISTIC-61575887789253/) and authored by [Rayene9052](https://github.com/Rayene9052).
...
2. Get the file name.
3. Use `asyncio` to send multiple requests to the `/api/run/file_id.py` endpoint to run the script and get the flag.
